...
meanseeds<-ggplot(all_data, aes(x = Aphids_end, y = MeanSeedsPerPod, color = Aphids_end)) +   geom_boxplot()+
...
totalseeds<-ggplot(all_data, aes(x = Aphids_end, y = TotalSeedMass, color = Aphids_end))+
  geom_boxplot()+
 geom_point(alpha=0.6, position=position_jitterdodge(0.2))+
...
seedcount<-ggplot(all_data, aes(x = Aphids_end, y = Total_seeds, color = Aphids_end)) + geom_boxplot()+geom_point(alpha=0.6, position=position_jitterdodge(0.2))+
  theme(axis.text.x= element_blank())+
  theme(axis.text.y= element_text(size=16))+
  theme(axis.title.x=element_blank())+
  theme(axis.title.y=element_text(size=10))+
...
plot_grid(seedcount,meanseeds,totalseeds,ncol=1,labels=c("A","B","C"))
```
